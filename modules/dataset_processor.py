...
class KILT100w(Processor):
    ...
    def process(self):
        ...
        dataset = datasets.load_dataset(hf_name, "2019-08-01", num_proc=self.num_proc, trust_remote_code=True, storage_options={'client_kwargs': {'timeout': aiohttp.ClientTimeout(total=3600)}})[self.split]
