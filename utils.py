...
def prepare_dataset_from_ids(dataset, q_ids, d_ids, scores=None, multi_doc=False, query_field="content", oracle_provenance=False):
            ...
            for i, q_id in tqdm(enumerate(q_ids), desc='Fetching data from dataset...', total=len(q_ids)):
                ...
                if multi_doc:
                    ...
                    if scores is not None:
                        x['retrieval_scores'] = scores[i][:len(d_ids_)]
